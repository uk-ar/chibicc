...
assert 2 "main(){for(a=1;a;a=a-1)return 2;}"
assert 0 "main(){a=1;for(;a;)a=a-1;return a;}"
assert 1 "main(){if(1==1)return 1;}"
assert 2 "main(){if(1!=1)return 1;else return 2;}"
assert 2 "main(){a=1;while(a)a=a-1;return 2;}"
assert 0 "main(){a=1;while(a)a=a-1;return a;}"
assert 3 "main(){return 3;}"
assert 3 "main(){foo=3;return foo;}"
assert 5 "main(){foo=3;return 2+3;}"
assert 3 "main(){foo=3;2;return foo;}"
assert 3 "main(){foo=3;2+3;return foo;}"
assert 4 "main(){foo=3;2+3;return foo+1;}"
